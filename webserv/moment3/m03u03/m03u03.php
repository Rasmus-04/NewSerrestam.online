...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../m03u01/m03u01.php">m03u01</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../m03u02/m03u02.php">m03u02</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="#">m03u03</a>
            </li>
            <li class="nav-item">
...
<main>
  ...
  <p><input type="submit" name="action" value="Registrera"></p>
  </form>

  <?php
  if(isset($_SESSION['name'])){
    echo "<h3>Namnet lagrad i din session är: ".$_SESSION["name"]."</h3>";
  }else{
    echo "<h3>Inget namn är lagrad i din session</h3>";
  }

  if(isset($_COOKIE['name'])){
    echo "<h3>Namnet lagrad i din cookie är: ".$_COOKIE['name']."</h3>";
  }else{
    echo "<h3>Inget namn är lagrad i din cookie</h3>";
  }
  ?>
